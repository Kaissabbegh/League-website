...
export default function Checkout() {
  ...
  return (
    <>
      <div className="bg-[url(static/bg.jpg)] bg-cover bg-center min-h-[100vh] pt-[50px] pb-20">
        <Header />
        {!cartInfo ? (
          ...
          <div className="bg-[#EBD3F8] rounded-2xl p-[40px]  xl:px-[200px] xl:mx-[400px] mx-[20px] mt-[100px] flex flex-col items-top justify-center gap-y-5">
            ...
            <div className="bg-[#EBD3F8] rounded-2xl xl:p-5 p-1 shadow-purple-950 shadow-sm xl:flex items-start justify-center ">
              <div className="relative flex items-center justify-center h-[70vh] w-[35vh] ">
                ...
                <div className="absolute h-[81%]">
                  <img
                    src={
                      cartInfo.skin
                        ? `${cartInfo.skin.image}`
                        : "src/static/jhinloadscreen_5.jpg"
                    }
                ...
                <div
                  className="bg-[url(static/lines.png)] absolute xl:w-[250px] bg-contain bg-center bg-no-repeat  w-full h-[30px] "
                  style={{
                    bottom: "20%",
                    left: "50%",
                ...
                <div
                  className="bg-[url(static/layer1.png)] absolute xl:size-[60px] size-[55px] bg-contain bg-center bg-no-repeat"
                  style={{
                    bottom: "16%",
                    left: "50%",
                    transform: "translateX(-50%)",
                ...
                <div
                  className="bg-[url(static/layer1.png)] absolute xl:size-[45px] size-[40px] bg-contain bg-center bg-no-repeat"
                  style={{
                    bottom: "16%",
                    left: "10%",
                  }}
                ...
                <div
                  className="bg-[url(static/layer1.png)] absolute xl:size-[30px] size-[25px] bg-contain bg-center bg-no-repeat"
                  style={{
                    bottom: "16%",
                    left: "21%",
                  }}
                ...
                <div
                  className="bg-[url(static/sums.png)] absolute xl:size-[35px] size-[30px] bg-contain bg-center bg-no-repeat"
                  style={{
                    bottom: "17%",
                    right: "22%",
                  }}
                ...
                <div className="flex items-center justify-center gap-2 xl:gap-10 flex-wrap">
                  ...
                  <div className="xl:max-w-[50%] ">
                    ...
                    <div className="flex space-x-4 mb-4">
                      ...
                      >
                        <div
                          class="bg-[url('static/edinar.png')] bg-contain bg-no-repeat bg-center w-32 h-32"
                          aria-label="Edinar"
                        ></div>
                      </div>
                    </div>
